...
import net.Kykokos.QuantumLands.Item.client.CentrifugeBlockItemRenderer;
...
public class CentrifugeItem extends BlockItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private CentrifugeBlockItemRenderer renderer;
            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if(this.renderer == null) {
                    this.renderer = new CentrifugeBlockItemRenderer();
                }
